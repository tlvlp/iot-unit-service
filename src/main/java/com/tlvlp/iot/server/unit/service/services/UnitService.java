...
public class UnitService {
    ...
    public UnitService(UnitRepository unitRepository, UnitErrorRepository errorRepository) {
        this.unitRepository = unitRepository;
        this.errorRepository = errorRepository;
    }

    void handleInactiveUnit(Message message) {
    ...
    void  handleUnitStatus(Message message) {
    ...
    void handleUnitError(Message message) throws IllegalArgumentException{
